...
describe('Custom user tests: Bonus - degenerate triangle', () => {
  test('Not a degenerate triangle when equilateral', () => {
    const triangle = new Triangle(10, 10, 10)
    expect(triangle.isDegenerateTriangle()).toBe(false)
  })

  test('Not a degenerate triangle when isosceles', () => {
    const triangle = new Triangle(10, 10, 5)
    expect(triangle.isDegenerateTriangle()).toBe(false)
  })

  test('Not a degenerate triangle when scalene', () => {
    const triangle = new Triangle(10, 9, 8)
    expect(triangle.isDegenerateTriangle()).toBe(false)
  })

  test('triangle is degenerate, 1', () => {
    const triangle = new Triangle(10, 10, 20)
    expect(triangle.isDegenerateTriangle()).toBe(true)
  })

  test('triangle is degenerate, 2', () => {
    const triangle = new Triangle(10, 20, 10)
    expect(triangle.isDegenerateTriangle()).toBe(true)
  })

  test('triangle is degenerate, 3', () => {
    const triangle = new Triangle(20, 10, 10)
    expect(triangle.isDegenerateTriangle()).toBe(true)
  })
})